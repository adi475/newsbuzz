...
export default function App() {
  ...
  return (
    <>
     ...
     />
        <Routes>
        <Route path="/" element={<News updateProgress={setProgress} apiKey={apiKey} key="general" pageSize={10} country= "in" category= "general" />}/>
        <Route path="/Health" element={<News updateProgress={setProgress} apiKey={apiKey} key="health" pageSize={10} country= "in" category= "health" />}/>
        <Route path="/Business" element={<News updateProgress={setProgress} apiKey={apiKey} key="business" pageSize={10} country= "in" category= "business" />}/>
        <Route path="/Technology" element={<News  updateProgress={setProgress} apiKey={apiKey} key="technology" pageSize={10} country= "in" category= "technology" />}/>
        <Route path="/Sports" element={<News updateProgress={setProgress} apiKey={apiKey} key="sports" pageSize={10} country= "in" category= "sports" />}/>
        <Route path="/Entertainment" element={<News updateProgress={setProgress} apiKey={apiKey} key="entertainment" pageSize={10} country= "in" category= "entertainment" />}/>
        </Routes>
        </BrowserRouter>
